...
document.addEventListener("DOMContentLoaded", (function () {
    let is_viewed = localStorage.getItem('us_nesletter') || false;

    if (!is_viewed) {
        console.log("show nesletter modellllll");

        setTimeout(() => {
            UniCore.modal("#uc-newsletter-modal").show(),
                console.log(";lkajfsdak;fljlsdk;fjlk;saj;lk");


        }, 10000);
        localStorage.setItem("us_nesletter", true);
    }
    document.getElementById('save-news-languages').addEventListener('click', function (e) {
        localStorage.removeItem('us_nesletter')
        console.log("Newsletter modal reset.");
    });
}
)),
    document.addEventListener("DOMContentLoaded", (function () {
