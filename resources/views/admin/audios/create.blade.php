...
@section('content')
    <section class="section">
        <div class="card admin_cards">
            ...
            <form action="{{ url($url) }}" class="form-horizontal" enctype="multipart/form-data" id="addAudioForm"
                ...
                <div class="card-body">
                    <div class="row row-cards">
                        ...
                        @can('select-newslanguage-for-AudioPost')
                        ...
                        @can('select-channel-for-AudioPost')
                        ...
                        @can('select-topic-for-AudioPost')
                            <div class="col-sm-6 col-md-6 mt-3 d-none">
                        ...
                        <div class="col-sm-6 col-md-6 mt-3">
                            ...
                            <span class="parsley-required"><strong id="audio-error"></strong></span>
                    ...
                    <div class="modal-footer gap-2">
                        ...
                        <button type="submit" id="audio_submite_button"
