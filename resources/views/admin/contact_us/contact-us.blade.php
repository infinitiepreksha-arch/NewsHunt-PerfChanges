        ...
        @can('list-contactus')
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <table class=" ms-2 table table-bordered text-nowrap border-bottom" id="contact_us_table"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-20p border-bottom-0">{{ __('global.CONTACT_NUMBER') }}</th>
                                        <th class="wd-15p border-bottom-0">{{ __('global.EMAIL') }}</th>
                                        <th class="wd-15p border-bottom-0">{{ __('global.MESSAGE') }}</th>
        ...
        @else
            <div class="col-12 text-center py-5">
                ...
                <div class="d-inline-block">
                    <h3 class="text-danger mb-0">You do not have permission to view the list of Contact Us.
                    </h3>
                </div>
            </div>
        @endcan
