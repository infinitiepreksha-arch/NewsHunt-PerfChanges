    ...
    <section class="section">
        <div id="videoPostFormModal" aria-hidden="true">
            <div class="card admin_cards">
                ...
                <form action="{{ url($url) }}"class="form-horizontal" id="videoPostForm" method="{{ $method }}"
                    ...
                    <div class="card-body">
                        <div class="row row-cards">
                            ...
                            <div class="col-sm-6 col-md-6 d-none" id="video_thumbnail">
                                ...
                                <span class="parsley-required"><strong id="thumb_image-error"></strong></span>
                                <div class="mt-3">
                            ...
                            <div class="col-sm-6 col-md-6 d-none" id="video_file">
                                ...
                                <span class="parsley-required"><strong id="video-error"></strong></span>
                                <div class="mt-3">
                                    {{-- @if ($post->video_type === 'youtube')
                                    <iframe width="420" height="345" src="{{ $post->video ?? '' }}">
                                    </iframe>
                                @else --}}
                        ...
                        <div class="modal-footer gap-2">
                            <a href="{{ url('admin/posts') }}" id="video_back_button"
                                class="btn btn-secondary">{{ __('page.BACK') }}</a>
                            <button type="submit" id="video_submite_button"
