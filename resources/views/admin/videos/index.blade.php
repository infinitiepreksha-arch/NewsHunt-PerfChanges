...
@section('page-title')
    <div class="row g-2 align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none d-flex flex-row flex-md-row gap-2">
            @can('create-custom-VideoPost')
                <a class="btn btn-primary w-auto" href="{{ route('videos.create.custom') }}">{{ __('page.CREATE_VIDEOS') }}</a>
            @endcan

            @can('create-youtube-VideoPost')
                <a href="{{ route('videos.create.youtube') }}" class="btn btn-danger w-auto">
                    {{ __('page.YOUTUBE_VIDEO') }}</a>
            @endcan
        </div>
    </div>
@endsection
                                                ...
                                                <div class="input-icon">
                                                    <div class="col-auto d-print-none">
                                                        <div class="nav-item dropdown">
                                                            <select id="select-filter" class="form-select mb-2" data-default="{{ $default_filter ?? "" }}">
                                                                <option value="video_posts">{{ __('page.VIDEO_POSTS') }}
                                                                <option value="youtube_videos">{{ __('page.YOUTUBE_VIDEO') }}
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-md-auto ms-md-auto d-print-none mt-3 mt-md-0">
                                            <div class="d-flex flex-wrap align-items-center gap-1">
                                                <div class="d-none border rounded py-2 bg-primary text-white p-2"
                                                    id="select-all-video-posts">
                                                    <div class="form-check mb-0">
                                                        <input type="checkbox" id="select-all-video-checkbox"
                                                ...
                                                <div class="d-none" id="bulk-video-delete-btn">
                                                    <button class="btn btn-danger" id="bulk-video-delete-action">
                                ...
                                @else
                                    <div class="col-12 text-center py-5">
                                        ...
                                        <div class="d-inline-block">
                                            <h3 class="text-danger mb-0">You do not have permission to view the list of Video
                                                Posts.
                                            </h3>
                                        </div>
                                    </div>
                    ...
                    @can('list-VideoPost')
                        <div class="page-body">
                            <div class="container-xl" id=post_card_hover>
                                <div id="video-container" class="row row-cards" data-url="{{ route('videos.show', 1) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-1">
                                        <div id="total-video-posts" class="text-secondary mt-1">{{ __('page.LOADING') }}
                                        </div>
                                    </div>

                                    <div class="col-md-8">
                                        <div class="mt-3 d-flex">
                                            <ul class="pagination ms-auto" id="video-pagination-container"></ul>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    <div class="card card-sm">
                        <div id="post-media">
                            ...
                            <video id="video-preview" class="w-100 h-100 d-none" controls>
                                <source src="" type="video/mp4">
                                <track src="descriptions_en.vtt" kind="descriptions" srclang="en"
                                    label="English Descriptions">
                            </video>

                            <iframe height="315" class="w-100" src="" id="video_frame" class="d-none"
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-2 mt-2">
                                <span class="text-start mt-2">
                                    <a href="javascript:void(0)" id="read-more-btn" class="text-primary fw-bold mt-2" style="display: none;">Read more</a>
                                </span>
                                <div>
                                    ...
                                    @can('update-custom-VideoPost')
                                        <a class="btn btn-primary btn-sm rounded d-none mt-2" href="#"
                                            id="edit-video-custom-btn">
                                            {{ __('page.EDIT_VIDEO') }}
                                        </a>
                                    @endcan

                                    <a class="btn btn-primary btn-sm rounded mt-2" href="#"
                                        id="notification-video-custom-btn">{{ __('message.SEND_NOTIFICATION') }}</a>

                                    @can('update-youtube-VideoPost')
                                        <a class="btn btn-primary btn-sm rounded d-none mt-2" href="#"
                                            id="edit-video-youtube-btn">
                                            {{ __('page.EDIT_YOUTUBE') }}
                                        </a>
                                    @endcan
                                    
                                    @if (auth()->user()->can('delete-custom-VideoPost') || auth()->user()->can('delete-youtube-VideoPost'))
