...
class ResponseService
{
    ...
    public static function noPermissionThenRedirect($permission)
    {
        if (! Auth::user()->can($permission)) {
            return response()->view('admin.errors.permission_restricted', [
     ...
     * @return void
     */
    public static function successResponse(string | null $message = "Success", $data = null, array $customData = [], $code = null)
    {
